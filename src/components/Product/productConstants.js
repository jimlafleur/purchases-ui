...
export const clearProductAddForm = setters => setters.setName('')

export const createProductForPut = (states, currentRow) => {
    return {
        object: {name: states?.name, id: currentRow?.id},
        params: {categoryId: states?.categoryId}
    }
}